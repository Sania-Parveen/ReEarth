...
const Sidebar = ({ onSignOut }) => {
  ...
  const menuItems = [
    { path: "/dashboard", label: "Profile", icon: <User size={20} /> }, // ✅ Changed path to /dashboard
    { path: "/", label: "Home", icon: <HomeIcon size={20} /> },
    { path: "/events", label: "Events", icon: <Calendar size={20} /> },
    { path: "/predict", label: "Waste Predictor", icon: <BrainCircuit size={20} /> },
    { path: "/blog", label: "Blog", icon: <BookOpen size={20} /> },
    { path: "/chat", label: "Chat", icon: <MessageSquare size={20} /> },
    { path: "/partners", label: "Recycling Partners", icon: <Users size={20} /> },
